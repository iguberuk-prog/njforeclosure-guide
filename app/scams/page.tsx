...
export const metadata: Metadata = {
  title: fitTitle('Foreclosure Rescue Scams in NJ | The Red Flags'),
  description:
    fitDescription('How to tell real foreclosure help from a scam in New Jersey: the red flags, what state and federal law actually prohibits, and where to report it. Upfront fees for foreclosure relief are illegal.'),
  alternates: {
