...
export const metadata: Metadata = {
  ...
  title: fitTitle('Selling to a Cash Buyer Before a NJ Sheriff Sale'),
  description: fitDescription('How a fast cash sale actually works in New Jersey foreclosure: real timelines, what it costs versus a market sale, and the questions to ask before signing.'),
};
