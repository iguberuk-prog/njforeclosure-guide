        ...
        <div className="max-w-6xl mx-auto px-4">
          ...
          <div className="border-t border-white/5 pt-8 text-center text-xs text-slate-600 space-y-3">
            <p>&copy; 2026 NJ Foreclosure Guide. All rights reserved. &middot;{' '}
              <a href="https://www.instagram.com/njforeclosureguide/" target="_blank" rel="noopener noreferrer" className="underline hover:text-slate-400 transition">Instagram</a> &middot;{' '}
              <a href="https://www.facebook.com/profile.php?id=61594272767455" target="_blank" rel="noopener noreferrer" className="underline hover:text-slate-400 transition">Facebook</a></p>
