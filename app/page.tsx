      ...
      >
        ...
        <div className="max-w-6xl mx-auto relative z-10">
          ...
          <div className="mb-20 text-center">
            <div className="flex justify-center mb-8">
              <img src="/images/verified-badge.png" alt="Verified - Trusted by 2300+ NJ Families" className="h-20 w-20 drop-shadow-lg" />
            </div>
      ...
      {showReviews && (
        <div className="fixed inset-0 bg-black/50 backdrop-blur-sm z-50 flex items-center justify-center p-4 animate-fadeIn">
          <div className="bg-white rounded-2xl shadow-2xl max-w-2xl w-full max-h-[90vh] overflow-y-auto">
            {/* Header */}
            <div className="sticky top-0 bg-gradient-to-r from-blue-900 to-blue-950 text-white p-6 border-b border-blue-800">
              <div className="flex items-center justify-between mb-4">
                <img src="/images/verified-badge.png" alt="Verified - Trusted by 2300+ NJ Families" className="h-16 w-16 drop-shadow-lg" />
                <button
