    ...
    <div className="min-h-full bg-white">
      ...
      <section className="max-w-3xl mx-auto px-4 pt-10">
        <div className="rounded-xl border border-amber-300 bg-amber-50 p-5">
          <p className="text-sm text-amber-900 leading-relaxed">
            <span className="font-bold">How we are paid:</span> Private Sale Group is a referral partner, which means we receive a fee if you sell through them. You are never charged anything. At this price point, get more than one number before you commit. Nothing on this page is an appraisal, a valuation, or advice to accept any particular offer.
          </p>
        </div>
      </section>
      ...
      <section className="max-w-3xl mx-auto px-4 pb-16">
        ...
        <p className="text-xs text-slate-400 mt-8 leading-relaxed text-center max-w-2xl mx-auto">
          NJ Foreclosure Guide is an educational resource and is not affiliated with Private Sale Group beyond a referral relationship. We are not a law firm, lender, or real estate brokerage, and nothing here is legal, tax, or financial advice. Details are drawn from Private Sale Group&apos;s public website and may change. Confirm all terms directly with them and have an attorney review any agreement before you sign.
        </p>
      </section>
