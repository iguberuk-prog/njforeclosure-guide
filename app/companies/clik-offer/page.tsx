    ...
    <div className="min-h-full bg-white">
      ...
      <section className="max-w-3xl mx-auto px-4 pt-10">
        <div className="rounded-xl border border-amber-300 bg-amber-50 p-5">
          <p className="text-sm text-amber-900 leading-relaxed">
            <span className="font-bold">How we are paid:</span> Clik Offer is a referral partner, which means we receive a fee if you sell to them. You are never charged anything. Get more than one offer before you commit. Nothing on this page is an appraisal, a valuation, or advice to accept any particular offer.
          </p>
        </div>
      </section>
      ...
      <section className="max-w-3xl mx-auto px-4 pb-16">
        ...
        <p className="text-xs text-slate-400 mt-8 leading-relaxed text-center max-w-2xl mx-auto">
          NJ Foreclosure Guide is an educational resource and is not affiliated with Clik Offer beyond a referral relationship. We are not a law firm, lender, or real estate brokerage, and nothing here is legal, tax, or financial advice. Details are drawn from Clik Offer&apos;s public website and may change. Confirm all terms directly with them and consider having an attorney review any offer before you sign.
        </p>
      </section>
      ...
      <footer className="bg-slate-950 text-slate-500 py-10 px-4 text-center text-xs">
        ...
        <p className="max-w-2xl mx-auto leading-relaxed">
          Educational resource only. Not a law firm, lender, or real estate company. Some partners pay us a referral fee and one is an affiliated business, both disclosed on their pages. We are not paid by attorneys or nonprofits, and you are never charged.
        </p>
      </footer>
    </div>
  );
