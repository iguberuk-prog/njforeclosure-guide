...
const SECTIONS: { title: string; items: { href: string; name: string; desc: string }[] }[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { href: '/nj-map', name: 'The NJ Foreclosure Map', desc: 'All 21 counties on one tap: sheriff sale contacts, official listings, and the free local orgs \u2014 every fact verified.' },
      ...
      { href: '/tools/cost-of-waiting', name: 'The Cost of Waiting meter', desc: 'Drag the slider and watch what doing nothing costs: fees stacking, doors closing, equity leaking.' },
