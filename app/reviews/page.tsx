    ...
    <div className="min-h-full bg-white">
      ...
      <footer className="bg-slate-950 text-slate-500 py-10 px-4 text-center text-xs">
        ...
        <p className="max-w-2xl mx-auto leading-relaxed">
          Independent educational resource. Not a law firm, lender, or real estate company. We are paid
          by nobody: no referral fees, no commissions, no advertising money, and no affiliation with any
          company listed. You are never charged.
        </p>
      </footer>
    </div>
  );
